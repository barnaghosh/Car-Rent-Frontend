...
import img4 from '../asset/double/Noah10.jpg'
    ...
    render() {
        ...
        return (
            <div className='container'  style={{padding:'20px 0px'}}>
                ...
                <Room imgArr={imgArr} room='double' bookButton={this.Book} signup={this.signup} login={this.login} book={this.props.book} history={this.history} />
            </div>
        )
    }
}
